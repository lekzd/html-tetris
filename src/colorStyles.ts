...
export const JOIN_ROOM_THEME = {
  ...
  asciiLink: '/arts/stars.txt',
  asciiColor: color('#3f3f3f'),
...
export const COLOR_STYLES = {
  Monokai: {
    ...
    asciiLink: '/arts/rombs.txt',
    asciiColor: color('#33352c'),
  ...
  Far: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/world_map.txt',
    asciiColor: color('#0000cd'),
  ...
  Gruvbox: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/hexagons.txt',
    asciiColor: color('#3c3836'),
  ...
  Lightfair: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/bricks.txt',
    asciiColor: color('#652d2c'),
  ...
  Nord: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/drakard.txt',
    asciiColor: color('#3b4252'),
  ...
  Qtcreator: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/paving_slabs.txt',
    asciiColor: color('#1d1d1d'),
  ...
  Solarized: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/jgs_bridge.txt',
    asciiColor: color('#003948'),
  ...
  Github: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/oktocat.txt',
    asciiColor: color('#e8d1f8'),
  ...
  Dracula: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/castle.txt',
    asciiColor: color('#2f3c42'),
  ...
  GardenOfEden: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/hypno_frog.txt',
    asciiColor: color('#005d5d'),
  ...
  Matrix: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/matrix.txt',
    asciiColor: color('#0f290f'),
    [SymbolType.BACKGROUND]: color('#000000'),
    [SymbolType.NUMBERS_BG]: color('#000000'),
  ...
  Strawberry: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/pikachu.txt',
    asciiColor: color('#e0c5cc'),
  ...
  ColorsOff: {
    ...
    finalShader: commonShader,
    affectedShader: commonShader,
    asciiLink: '/arts/saturn.txt',
    asciiColor: color('#3d3d3d'),
    [SymbolType.BACKGROUND]: color('#313131'),
    [SymbolType.NUMBERS_BG]: color('#313131'),
    [SymbolType.HIGHLIGHT]: color('#3e3e3e'),
